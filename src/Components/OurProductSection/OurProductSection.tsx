                                ...
                                <div className="bg-white shadow-md rounded-2xl overflow-hidden flex flex-col hover:shadow-lg transition group-hover:scale-[1.02]">
                                    ...
                                    <div className="p-3 flex flex-col flex-1">
                                        ...
                                        <div className="mt-auto flex gap-2">
                                            <button
                                                className="flex-1 cursor-pointer bg-[#4a3939] hover:bg-[#7a6060] text-white py-2 rounded-lg text-sm font-semibold transition"
                                                onClick={(e) => e.preventDefault()}
                                            >
                                                Add to Cart
                                            </button>
                                            <button
                                                className="flex-1 cursor-pointer bg-[#EFC879] hover:bg-amber-700 text-white py-2 rounded-lg text-sm font-semibold transition"
                                                onClick={(e) => e.preventDefault()}
                                            >
                                                Buy Now
                                            </button>
