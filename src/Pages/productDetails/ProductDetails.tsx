...
import { getProductDetails } from '../../api/getDetails';
import { useQuery } from '@tanstack/react-query';
import type { Coffee } from '../../types/types';
import Loader from '../../Components/UI/Loader';
import { toast } from 'react-toastify';
const CustomerCoffeeDetails = lazy(() => import('../../Components/CustomerCoffeeDetails/CustomerCoffeeDetails'))
...
const ProductDetails: React.FunctionComponent = () => {
    ...
    return (
        <>
            <Suspense >
                <CustomerCoffeeDetails data={data} />
            </Suspense>
        </>
    );
};
